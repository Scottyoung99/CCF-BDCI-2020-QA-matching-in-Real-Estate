...
if __name__ == '__main__':
    ...
    for tr_idx, val_idx in kf.split(train_data):
        ...
        save_path = './model/best_bt_wwm.ckpt'
        ...
        for epoch in range(1, epochs + 1):
            ...
            torch.save(model.state_dict(), './model/last_bt_wwm.ckpt')
    ...
    submit['label'] = res
    submit.to_csv('./results/submit_cv_bt_wwm.tsv', sep='\t', header=False, index=False)